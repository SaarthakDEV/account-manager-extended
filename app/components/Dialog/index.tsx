...
const Dialog: FC<DialogProps> = ({
  ...
  return (
    <div className="h-screen w-screen absolute flex justify-center items-center top-0 left-0">
      <div className="static h-[40vh] w-[50vw] rounded-xl shadow-2xl flex flex-col bg-gray-50">
        <div className="flex-1 p-4">{children}</div>
        { needFooter && <footer className="h-16 flex justify-center items-center gap-10 bg-gray-100 rounded-b-xl">
          <button
            onClick={onConfirm}
